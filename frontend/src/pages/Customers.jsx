                ...
                {customers.length > 0 ? (
                  customers.map(c => (
                    ...
                    >
                      ...
                      <td className="p-4"><PhoneWithFlag phone={c.mobile} textClassName="font-medium text-slate-550 dark:text-slate-400" /></td>
                      <td className="p-4">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-0.5 mt-1">
                <div className="text-xs text-slate-450 dark:text-slate-400 font-medium flex items-center gap-1">
                  <span>Mobile:</span> <PhoneWithFlag phone={selectedCustomer.mobile} textClassName="font-medium" />
                </div>
                {selectedCustomer.alternateNumber && (
                  <div className="text-xs text-slate-450 dark:text-slate-400 font-medium flex items-center gap-1">
                    <span>Alternate:</span> <PhoneWithFlag phone={selectedCustomer.alternateNumber} textClassName="font-medium" />
                  </div>
                )}
