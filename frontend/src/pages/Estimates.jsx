                            ...
                            <div className="space-y-3 pl-4">
                              <div className="flex justify-between items-center">
                                ...
                                <div className="flex gap-2">
                                  ...
                                  >
                                    <Download className="w-3 h-3" /> Get {pdfType === 'customer' ? 'Customer' : 'GST'} PDF
                                  </button>
                                </div>
                              </div>
