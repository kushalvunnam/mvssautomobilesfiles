...
export default function Header({ user, token, currentTab, onMenuClick, onLogout, onNavigate, onNavigateToJobCard }) {
  ...
  return (
    <header ref={headerRef} className="flex flex-col md:flex-row md:h-16 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-2.5 sm:px-4 md:px-6 py-2.5 sm:py-3 md:py-0 justify-between items-stretch md:items-center gap-3 select-none relative z-40">
      ...
      <div className="w-full flex justify-between items-center md:contents">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 md:gap-3.5 min-w-0 md:order-1">
          <button
            onClick={() => {
              setShowNotificationsMenu(false);
              setShowMessagesMenu(false);
        ...
        {/* Right Side Widgets */}
        <div className="flex items-center gap-0.5 sm:gap-2 md:gap-3.5 shrink-0 md:order-3">
          ...
          <div className="flex items-center gap-0.5">
            ...
            <button
              ...
              className="p-1.5 sm:p-2 text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-colors"
              title="Toggle Theme"
            >
            ...
            <div className="relative">
              <button
                ...
                className="p-1.5 sm:p-2 text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-colors relative"
