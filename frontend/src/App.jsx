  ...
  return (
    <div className="flex bg-[#F8FAFC] dark:bg-slate-950 min-h-screen font-sans">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden min-w-0">
            ...
            <div className="min-h-[70vh] flex items-center justify-center p-6 animate-fade-in">
              <div className="glassmorphism max-w-md w-full p-8 rounded-3xl border border-red-500/20 text-center relative overflow-hidden space-y-6 shadow-[0_0_50px_rgba(239,68,68,0.05)]">
                ...
                <p className="text-[10px] font-semibold text-slate-500">
                  Please sign out and sign in using an authorized profile to launch this workspace console.
                </p>
              </div>
            </div>
          ) : (
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-t border-slate-200/80 dark:border-slate-800/80 md:hidden flex justify-around items-center h-auto pt-2 pb-safe px-2 z-40 shadow-[0_-4px_12px_rgba(0,0,0,0.05)] dark:shadow-[0_-4px_12px_rgba(0,0,0,0.3)]">
